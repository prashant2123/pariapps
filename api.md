...
- __Application__ refers to API Insight, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to API Insight.
...
- By email: mail02prashant@gmail.com
